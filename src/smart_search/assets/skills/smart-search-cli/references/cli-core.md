...
- AnySearch is not a Smart Search CLI command family. The agent resolves and reads the bundled or global AnySearch Skill, then follows that Skill's current interface.
