# A1 Citation-backed Research Workspace

This directory is the durable Workspace for **审计 xAI、OpenAI、Exa、Tavily、Firecrawl 和 Jina Reader 的官方错误身份、重试边界与限流等待信号，并记录 Smart Search 的接受观察。**. It was
...
- [Artifact registry](runtime/run-transient-a1-20260826/artifacts.jsonl)
